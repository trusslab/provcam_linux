...
// Shiroha: trick for comforting both imx274 and iic-controller
		...
		dma_addr_t *dma_handle, gfp_t gfp)
{
	...
	// 		printk("[Shiroha]%s: now we have cached imx-iic addr: 0x%016llx.\n", __func__, cached_iic_virt_addr);
	// 	}
	// 	printk("[Shiroha]%s: going to return imx-iic addr: 0x%016llx.\n", __func__, cached_iic_virt_addr);
